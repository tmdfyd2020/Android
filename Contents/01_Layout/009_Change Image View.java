...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // □ findViewById : XML 파일에서 추가한 뷰의 ID를 사용하여 뷰를 찾는 메소드, id가 인자로 들어간다.
    }
...
// □ 소스 파일에 있는 setContentView 메소드가 파라미터로 XML 파일을 넘겨줄 수 있는데, 이 파라미터를 이용해 소스 파일과 XML 파일이 연결된다.

// □ 화면에서 이미지가 바뀌어 보이는 것처럼 보이지만 실제로는 중첩된 이미지 상태에서 하나를 보이게 하거나 하나를 보이지 않게 하는 방법을 사용한 것이다.
